...
class wvrDaq():
    ...
    def __init__(self, logger=None, 
        ...
        self.wvr = wvrComm.wvrComm(debug=debug)
        self.peri = wvrPeriComm.wvrPeriComm(logger= logger, debug=debug)
        self.wvrEl =  StepperCmd.stepperCmd(logger = logger, debug=debug)
        self.wvrEl.initPort()
        self.chan = chan
    ...
    def setReg(self, reglist):
        ...
        reg_dict['AZ'] = (self.encoders, None, [0], ('AZ',))
        reg_dict['EL'] = (self.encoders, None, [1], ('EL',))
